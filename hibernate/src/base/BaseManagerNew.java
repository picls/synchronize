...
public class BaseManagerNew {

	public static void main(String args[]) {
		List l = (List) BaseManagerNew.select("com.dao.s.SUser", 10,
				"where article > 10", "order by article");
		l = (List) BaseManagerNew.selectByProperty("com.dao.s.SPage", "boardId",
	...
	public static Object select(String classname, int num, String con,
			String ord) {
		List result = (List) BaseManagerNew.select(classname, con, ord);
